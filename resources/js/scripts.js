...
function validate() {
  // lay value cua id name nha ae
  var name = document.getElementById("name").value; 
  // lay value cua id phone nha ae
  // var phone = document.getElementById("phone").value; 
  // lay value cua id email nha ae
  var email = document.getElementById("email").value; 
  // lay value cua id message nha ae
  // var message = document.getElementById("message").value; 
  // lay value cua id error_message nha ae
  var error_message = document.getElementById("error_message"); 
  // lay value cua id pw nha ae
  let password = document.getElementById("password").value; 
// lay value cua id confirmPassword nha ae
